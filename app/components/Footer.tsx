		...
		<footer className=" body-font dark:bg-black">
			<div className="container px-32 py-8 mx-auto flex items-center sm:flex-row flex-col">
				<a className="flex title-font font-medium items-center md:justify-start justify-center">
					...
					<span className="ml-3 text-xl dark:text-white">Daniela</span>
				</a>
				...
				<span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
					<Link href="https://www.facebook.com/people/Estudio-Previsional-Integral/61565100357558/" className="text-gray-500">
						<svg
							fill="currentColor"
							strokeLinecap="round"
							strokeLinejoin="round"
