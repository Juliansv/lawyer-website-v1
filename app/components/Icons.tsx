...
export const CalculatorIcon = () => (
	...
	>
		...
		></g>
		<g id="SVGRepo_iconCarrier">
			<path d="M928.1 881v44H95.9V99h44v782z" fill="#3A3BCD"></path>
			<path
	...
	>
		...
		<g id="SVGRepo_iconCarrier">
			...
			<path
				...
				fill="#3A3BCD"
			></path>
			<path d="M280.5 530h325.9v16H280.5z" fill="#3A3BCD"></path>
			<path d="M639.5 530h90.2v16h-90.2z" fill="#3A3BCD"></path>
			<path d="M403.5 641.8h277v16h-277z" fill="#3A3BCD"></path>
			<path d="M280.6 641.8h91.2v16h-91.2z" fill="#3A3BCD"></path>
			<path d="M279.9 753.7h326.5v16H279.9z" fill="#3A3BCD"></path>
			<path d="M655.8 753.7h73.9v16h-73.9z" fill="#3A3BCD"></path>
		</g>
	</svg>
);
	...
	>
		...
		<g id="SVGRepo_iconCarrier">
			...
			<g transform="translate(-728.199 -32.31)">
				...
				></rect>{" "}
				<path
					d="M2.649,0H22.972a0,0,0,0,1,0,0V5.3a0,0,0,0,1,0,0H2.649A2.649,2.649,0,0,1,0,2.649v0A2.649,2.649,0,0,1,2.649,0Z"
	...
	>
		...
		<g id="SVGRepo_iconCarrier">
			...
			<g transform="translate(-824.507 -32.514)">
				{" "}
				<path
					d="M849.477,73.36h-3V34.831a1.644,1.644,0,0,1,1.6-1.817h-.209a1.65,1.65,0,0,1,1.609,1.817Z"
					fill="none"
					stroke="#3A3BCD"
					strokeLinecap="round"
					strokeLinejoin="round"
				...
				<line
					x2="12"
					transform="translate(833.477 40.36)"
					strokeWidth="1"
					stroke="#3A3BCD"
					strokeLinecap="round"
					strokeLinejoin="round"
				...
				<line
					x2="11"
					transform="translate(850.477 40.36)"
					strokeWidth="1"
					stroke="#3A3BCD"
					strokeLinecap="round"
					strokeLinejoin="round"
				...
				></path>{" "}
				<path
					d="M825.164,59.36l8.188-19,6.438,19"
					fill="none"
					stroke="#3A3BCD"
					strokeLinecap="round"
					strokeLinejoin="round"
				...
				></path>{" "}
				<path
					d="M832.477,66.3a7.024,7.024,0,0,0,7.312-6.936H825.164A7.025,7.025,0,0,0,832.477,66.3Z"
					fill="none"
					stroke="#3A3BCD"
					strokeLinecap="round"
					strokeLinejoin="round"
				...
				></path>{" "}
				<path
					d="M870.289,59.36l-8.187-19-6.437,19"
					fill="none"
					stroke="#3A3BCD"
					strokeLinecap="round"
					strokeLinejoin="round"
				...
				></path>{" "}
				<path
					d="M862.977,66.3a7.025,7.025,0,0,1-7.313-6.936h14.625A7.024,7.024,0,0,1,862.977,66.3Z"
					fill="none"
					stroke="#3A3BCD"
					strokeLinecap="round"
					strokeLinejoin="round"
...
export const LogoIcon = () => (
	<svg
		...
		viewBox="0 0 48 48"
		strokeWidth="0.1"
		className="w-12 h-12 md:w-20 md:h-20 dark:fill-white p-2 rounded-full duration-0"
	>
		<g data-name="07-law" className="duration-0">
